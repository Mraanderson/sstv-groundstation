...
@recordings_bp.route("/files/<path:filename>")
...
@recordings_bp.route("/delete-file", methods=["POST"])
def delete_file():
...
@recordings_bp.route("/rename-file", methods=["POST"])
def rename_file():
